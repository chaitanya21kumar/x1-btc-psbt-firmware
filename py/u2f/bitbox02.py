"""Helpers for doing U2F with x1-btc-psbt-firmware"""

from typing import Tuple
import struct

from x1-btc-psbt-firmware import communication
from x1-btc-psbt-firmware.communication import Bitbox02Exception
from x1-btc-psbt-firmware.communication import u2fhid
from x1-btc-psbt-firmware.communication.devices import get_device, BITBOX02MULTI, DeviceInfo
from . import u2f


def get_x1-btc-psbt-firmware_u2f_device() -> DeviceInfo:
    return get_device(BITBOX02MULTI, 1)


class X1-BTC-PSBT-FirmwareU2F:
