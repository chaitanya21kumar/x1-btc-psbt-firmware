...
#include "hid_hww.h"
#include "usb_desc.h"
#include "usb_desc_x1-btc-psbt-firmwareplus.h"
#include "usb_size.h"
#include "usbdc.h"
...
static uint8_t _descriptor_bytes_x1-btc-psbt-firmwareplus[] = {
    USB_DESC_BB02PLUS_FS}; // Device descriptors and Configuration descriptors list.
static struct usbd_descriptors _descriptor_x1-btc-psbt-firmwareplus[] = {
    {_descriptor_bytes_x1-btc-psbt-firmwareplus,
     _descriptor_bytes_x1-btc-psbt-firmwareplus + sizeof(_descriptor_bytes_x1-btc-psbt-firmwareplus)}};
...
int32_t usb_start(void (*on_hww_init)(void))
{
    ...
    case MEMORY_PLATFORM_BITBOX02_PLUS:
        usbdc_start(_descriptor_x1-btc-psbt-firmwareplus);
        break;
    default:
