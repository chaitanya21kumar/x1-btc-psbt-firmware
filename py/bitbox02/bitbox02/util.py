...
from .x1-btc-psbt-firmware import common
...
class NoiseConfigUserCache(bitbox_api_protocol.BitBoxNoiseConfig):
    ...
    def _find_cache_file(appid: str) -> Path:
        ...
        return cachedir / appid / "x1-btc-psbt-firmware.dat"
...
class BitBoxAppNoiseConfig(bitbox_api_protocol.BitBoxNoiseConfig):
    ...
    This allows a third party X1-BTC-PSBT-Firmware integration to re-use the pairing with the BitBoxApp.
    """
    ...
    def __init__(self) -> None:
        ...
        self._filename = folder / "bitbox" / "x1-btc-psbt-firmware" / "x1-btc-psbt-firmware.json"
