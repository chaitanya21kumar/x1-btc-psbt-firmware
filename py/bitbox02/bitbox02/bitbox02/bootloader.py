...
""" Interact with a X1-BTC-PSBT-Firmware bootloader. """
...
from x1-btc-psbt-firmware.communication import TransportLayer

from x1-btc-psbt-firmware.communication.devices import (
    DeviceInfo,
...
class SecureChipModel(enum.Enum):
    """Secure chip model variants for the X1-BTC-PSBT-Firmware platform."""
...
class Bootloader:
    """
    One instance of a X1-BTC-PSBT-Firmware Bootloader, exposing the bootloader API.
    """
