...
try:
    from x1-btc-psbt-firmware.communication.generated import hww_pb2 as hww
    from x1-btc-psbt-firmware.communication.generated import eth_pb2 as eth
    from x1-btc-psbt-firmware.communication.generated import btc_pb2 as btc
    from x1-btc-psbt-firmware.communication.generated import cardano_pb2 as cardano
    from x1-btc-psbt-firmware.communication.generated import mnemonic_pb2 as mnemonic
    from x1-btc-psbt-firmware.communication.generated import x1-btc-psbt-firmware_system_pb2 as x1-btc-psbt-firmware_system
    from x1-btc-psbt-firmware.communication.generated import backup_commands_pb2 as backup
    from x1-btc-psbt-firmware.communication.generated import common_pb2 as common
    from x1-btc-psbt-firmware.communication.generated import keystore_pb2 as keystore
    from x1-btc-psbt-firmware.communication.generated import antiklepto_pb2 as antiklepto
    import google.protobuf.empty_pb2

    # pylint: disable=unused-import,ungrouped-imports
    # We export it in __init__.py
    from x1-btc-psbt-firmware.communication.generated import system_pb2 as system
...
class X1-BTC-PSBT-Firmware(BitBoxCommonAPI):
    """Class to communicate with a X1-BTC-PSBT-Firmware"""
    ...
    def device_info(self) -> Dict[str, Any]:
        ...
        # pylint: disable=no-member
        request = hww.Request()
        device_info_request = x1-btc-psbt-firmware_system.DeviceInfoRequest()
    ...
    def btc_sign_msg(
        ...
        compressed = 4  # X1-BTC-PSBT-Firmware uses only compressed pubkeys
    ...
    def check_sdcard(self) -> bool:
        # pylint: disable=no-member
        request = hww.Request()
        request.check_sdcard.CopyFrom(x1-btc-psbt-firmware_system.CheckSDCardRequest())
    ...
    def insert_sdcard(self) -> None:
        ...
        request.insert_remove_sdcard.CopyFrom(
            x1-btc-psbt-firmware_system.InsertRemoveSDCardRequest(
                action=x1-btc-psbt-firmware_system.InsertRemoveSDCardRequest.INSERT_CARD
            )
        )
        self._msg_query(request, expected_response="success")
    ...
    def root_fingerprint(self) -> bytes:
        """
        Get the root fingerprint from the x1-btc-psbt-firmware
        """
        # pylint: disable=no-member
        request = hww.Request()
    ...
    def reset(self) -> bool:
        ...
        request = hww.Request()
        # pylint: disable=no-member
        request.reset.CopyFrom(x1-btc-psbt-firmware_system.ResetRequest())
        try:
