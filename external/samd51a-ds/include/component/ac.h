...
typedef struct {
    ...
    __IO AC_EVCTRL_Type
    EVCTRL;      /**< \brief Offset: 0x02 (R/W 16) Event Control */
    ...
    __IO AC_DBGCTRL_Type
    DBGCTRL;     /**< \brief Offset: 0x09 (R/W  8) Debug Control */
    __IO AC_WINCTRL_Type
    WINCTRL;     /**< \brief Offset: 0x0A (R/W  8) Window Control */
    ...
    __I  AC_SYNCBUSY_Type
    SYNCBUSY;    /**< \brief Offset: 0x20 (R/  32) Synchronization Busy */
    __IO AC_CALIB_Type
    CALIB;       /**< \brief Offset: 0x24 (R/W 16) Calibration */
} Ac;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
