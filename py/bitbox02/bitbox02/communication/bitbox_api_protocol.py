...
class Platform(enum.Enum):
    ...
    BITBOX02 = "x1-btc-psbt-firmware"
    BITBOX02PLUS = "x1-btc-psbt-firmware-plus"


class X1-BTC-PSBT-FirmwareEdition(enum.Enum):
    """Editions for the X1-BTC-PSBT-Firmware platform"""
...
class FirmwareVersionOutdatedException(Exception):
    def __init__(self, version: semver.VersionInfo, required_version: semver.VersionInfo):
        super().__init__(
            "The X1-BTC-PSBT-Firmware's firmware is not up to date. Device: {}, Required: {}".format(
...
class LibraryVersionOutdatedException(Exception):
    def __init__(self, version: semver.VersionInfo):
        super().__init__(
            "The X1-BTC-PSBT-Firmware's firmware version {} is too new for this app. Update the app".format(
                version
            )
        )
...
class BitBoxCommonAPI:
    ...
    def __init__(
        ...
        if device_info is not None:
            ...
            if device_info["product_string"] in (BITBOX02MULTI, BITBOX02PLUS_MULTI):
                edition = X1-BTC-PSBT-FirmwareEdition.MULTI
            elif device_info["product_string"] in (BITBOX02BTC, BITBOX02PLUS_BTC):
                edition = X1-BTC-PSBT-FirmwareEdition.BTCONLY
        else:
    ...
    def get_info(
        transport: TransportLayer,
    ) -> Tuple[str, Platform, Union[X1-BTC-PSBT-FirmwareEdition], bool, Optional[bool]]:
        """
        ...
        edition: Union[X1-BTC-PSBT-FirmwareEdition]
        if platform in (Platform.BITBOX02, Platform.BITBOX02PLUS):
            edition = {0x00: X1-BTC-PSBT-FirmwareEdition.MULTI, 0x01: X1-BTC-PSBT-FirmwareEdition.BTCONLY}[edition_byte]
        else:
    ...
    def check_min_version(self) -> None:
        ...
        """
        if self.edition == X1-BTC-PSBT-FirmwareEdition.MULTI:
        ...
        elif self.edition == X1-BTC-PSBT-FirmwareEdition.BTCONLY:
