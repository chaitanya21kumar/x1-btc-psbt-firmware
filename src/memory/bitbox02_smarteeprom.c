...
#include "x1-btc-psbt-firmware_smarteeprom.h"
...
/**
 * Contents of the SmartEEPROM, as stored in the X1-BTC-PSBT-Firmware.
 * Version 1.
 *
...
} x1-btc-psbt-firmware_smarteeprom_image_v1_t;
...
{
    x1-btc-psbt-firmware_smarteeprom_image_v1_t new_image;
...
void x1-btc-psbt-firmware_smarteeprom_init(void)
{
...
uint8_t x1-btc-psbt-firmware_smarteeprom_get_unlock_attempts(void)
{
    uint8_t result;
    smarteeprom_read(
        offsetof(x1-btc-psbt-firmware_smarteeprom_image_v1_t, unlock_attempts),
        sizeof(((x1-btc-psbt-firmware_smarteeprom_image_v1_t*)0)->unlock_attempts),
        &result);
    /*
...
void x1-btc-psbt-firmware_smarteeprom_increment_unlock_attempts(void)
{
    uint8_t unlock_attempts = x1-btc-psbt-firmware_smarteeprom_get_unlock_attempts();
    /*
...
void x1-btc-psbt-firmware_smarteeprom_reset_unlock_attempts(void)
{
    /* Sanity-check the current value */
    (void)x1-btc-psbt-firmware_smarteeprom_get_unlock_attempts();
